          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-gray-300 mb-4 text-lg">
                La sécurité réseau vise à protéger les systèmes informatiques contre les accès non autorisés, les attaques et les intrusions.
              </p>
              ...
              <ul className="space-y-4 mb-6">
                <li className="flex items-start">
                  ...
                  <span className="text-gray-300">
                    <span className="font-semibold text-purple-300">Pare-feu (Firewall)</span> → contrôle le trafic réseau entrant et sortant.
                  </span>
                </li>
                <li className="flex items-start">
                  <div className="flex-shrink-0 h-6 w-6 rounded-full bg-purple-500/20 flex items-center justify-center mr-3 mt-0.5">
                  ...
                  <span className="text-gray-300">
                    <span className="font-semibold text-purple-300">VPN</span> → connexion sécurisée sur un réseau public.
                  </span>
                </li>
                <li className="flex items-start">
                  <div className="flex-shrink-0 h-6 w-6 rounded-full bg-purple-500/20 flex items-center justify-center mr-3 mt-0.5">
                  ...
                  <span className="text-gray-300">
                    <span className="font-semibold text-purple-300">Segmentation réseau</span> → limitation des zones vulnérables.
                  </span>
                </li>
              </ul>

              <p className="text-gray-400 text-sm md:text-base mb-6">
                La sécurité réseau est essentielle pour protéger les données, éviter les intrusions et garantir la confidentialité et l'intégrité des informations.
              </p>
                ...
                <div className="text-center p-6">
                  <div className="w-20 h-20 mx-auto mb-4 rounded-full bg-gradient-to-r from-purple-500 to-pink-500 flex items-center justify-center">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-10 w-10 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-10 0h10" />
                    </svg>
                  </div>
                  <p className="text-sm text-purple-300">
                    Illustration de sécurité réseau
                  </p>
                  <p className="mt-2 text-xs text-gray-400">
                    Protection des systèmes contre les intrusions et les attaques.
                  </p>
                </div>
              </div>
            </div>
